...
export const getAll = async (req: Request<{}, {}, {}, IQueryProps>, res: Response) => {
    ...
    const result = await IngredientsProvider.selectAll(req.query.page || 1, req.query.limit || 7, req.query.filter || "", req.query.uuid || "");    
    ...
    const count = await IngredientsProvider.totalCount(req.query.filter);    
...
export const getByUuid = async (req: Request<IParamProps>, res: Response) => {
    ...
    const result = await IngredientsProvider.selectByUuid(req.params.uuid);
